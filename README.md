...
```
cd existing_repo
git remote add origin https://gitlab.reutlingen-university.de/inf3-theteam/aufgaben-repo-inf3-sose14.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.reutlingen-university.de/inf3-theteam/aufgaben-repo-inf3-sose14/-/settings/integrations)
